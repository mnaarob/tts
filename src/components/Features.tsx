    ...
    <section id="results" className="scroll-mt-20 py-20 sm:py-24 bg-white border-y border-line">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-muted leading-relaxed max-w-2xl mb-10">
          Example projects we have helped bring online — storefronts and brands
          that sell real things. Past work is illustrative only.
        </p>

        <ul className="grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-10">
